...
outer:
	for scanner.Scan() {
		...
		// data generated by bulk_influxdb line protocol has ns timestamp at the end of each line.
		// We need to convert the timestamp TT supports (hardcoded as second)
